...
class DatabaseHelper {
  ...
  static const String _tblWatchMovielist = 'watchlist';
  static const String _tblWatchTvSerieslist = 'tvWatchlist';
  ...
  void _onCreate(Database db, int version) async {
    await db.execute('''
      CREATE TABLE  $_tblWatchMovielist (
  ...
  Future<int> insertMovieWatchlist(MovieTable movie) async {
    ...
    return await db!.insert(_tblWatchMovielist, movie.toJson());
  }
  ...
  Future<List<Map<String, dynamic>>> getWatchlistMovies() async {
    final db = await database;
    final List<Map<String, dynamic>> results = await db!.query(_tblWatchMovielist);
  ...
  Future<List<Map<String, dynamic>>> getWatchlistSeries() async {
    final db = await database;
    final List<Map<String, dynamic>> results = await db!.query(_tblWatchTvSerieslist);
