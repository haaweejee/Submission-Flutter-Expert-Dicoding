...
class TvSeriesRepositoryImpl extends TvSeriesRepository{
  ...
  @override
  Future<Either<Failure, String>> removeSeriesWatchlist(TvSeriesDetail series) async {
    try {
      final result =
      await localDataSource.removeSeriesWatchlist(TvSeriesTable.fromEntity(series));
      return Right(result);
  ...
  @override
  Future<Either<Failure, String>> saveSeriesWatchlist(TvSeriesDetail series) async {
    try {
      final result =
          await localDataSource.insertSeriesWatchlist(TvSeriesTable.fromEntity(series));
      return Right(result);
    } on DatabaseException catch (e) {
      return Left(DatabaseFailure(e.message));
    } catch (e) {
