...
void main() {
  ...
  group('save watchlist', () {
    test('should return success message when saving successful', () async {
      // arrange
      when(mockLocalDataSource.insertSeriesWatchlist(TvSeriesTable(id: 1, title: '', posterPath: '', overview: '')))
  ...
  group('remove watchlist', () {
    test('should return success message when remove successful', () async {
      // arrange
      when(mockLocalDataSource.removeSeriesWatchlist(TvSeriesTable(id: 1, title: '', posterPath: '', overview: '')))
